...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#6c918a] pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
      ...
      <div className="mt-12 border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[30px] text-gray-7 text-center">
        <div className="container">
          <p>Copyright {new Date().getFullYear()} | Shorecast Nova Scotia</p>
        </div>
      </div>
